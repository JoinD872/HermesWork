...
### Image understanding
For image understanding, use the MCP `mcp_minimax_plan_understand_image` tool instead of the built-in `vision_analyze` (which is disabled). The MCP tool is already configured and available.
